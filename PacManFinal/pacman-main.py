...
img1 = tkinter.PhotoImage(file='img1.gif')
img2 = tkinter.PhotoImage(file='img2.gif')
img3 = tkinter.PhotoImage(file='img3.gif')
hore1 = tkinter.PhotoImage(file='hore1.gif')
hore2 = tkinter.PhotoImage(file='hore2.gif')
hore3 = tkinter.PhotoImage(file='hore3.gif')
doprava1 = tkinter.PhotoImage(file='doprava1.gif')
doprava2 = tkinter.PhotoImage(file='doprava2.gif')
doprava3 = tkinter.PhotoImage(file='doprava3.gif')
dole1 = tkinter.PhotoImage(file='dole1.gif')
dole2 = tkinter.PhotoImage(file='dole2.gif')
dole3 = tkinter.PhotoImage(file='dole3.gif')
...
if mapnumber==1:
    wall = tkinter.PhotoImage(file='blank.gif')
...
bodka = tkinter.PhotoImage(file='bodka.gif')
...
bonusimg = tkinter.PhotoImage(file='bonus.gif')
